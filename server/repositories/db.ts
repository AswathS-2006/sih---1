...
class Database {
  ...
  private normalizeRolesAndSeedUsers() {
    ...
    // Synchronize facilities to include Clinics and new Big Hospitals
    const additionalFacilities: Facility[] = [
      {
        id: 'fac-kin-clinic',
        name: 'Kinathukadavu Ayushman Arogya Mandir (Health & Wellness Clinic)',
        type: 'Clinic',
        category: 'Public',
        latitude: 10.824,
        longitude: 77.020,
        address: 'Main Bazaar Road, Kinathukadavu Village, Coimbatore',
        district: 'Coimbatore',
        phone: '04259-224880',
        ...
        averageWaitTimeMin: 10,
        specialists: [
          { specialty: 'General Medicine', available: true, doctorName: 'Dr. Priya V. (CHO)' }
        ],
        services: [
          'Primary Outpatient Care (OPD)',
          'NCD Screening (BP & Blood Glucose)',
        ...
        availableDiagnostics: [
          ...
          'Digital BP & Pulse Oximetry'
        ],
        medicineStockRatio: 0.94
      },
      {
        id: 'fac-oth-clinic',
        name: 'Othakkalmandapam Community Family Health Clinic',
        type: 'Clinic',
        category: 'Public',
        latitude: 10.898,
        longitude: 76.996,
        address: 'Chettipalayam Road, Othakkalmandapam, Coimbatore',
        district: 'Coimbatore',
        phone: '0422-2615430',
        emergencyCapability: false,
        totalBeds: 10,
        ...
        specialists: [
          { specialty: 'General Medicine', available: true, doctorName: 'Dr. Anand Kumar' },
          { specialty: 'Pediatrics', available: true, doctorName: 'Dr. Shalini R.' }
        ],
        services: ['General OPD', 'Pediatric Immunization', 'Minor Wound Care', 'DOTS Tuberculosis Clinic'],
        availableDiagnostics: ['Blood Glucose', 'Digital BP', 'Rapid Malaria Kit', 'Hemoglobin (Hb)'],
        medicineStockRatio: 0.92
      },
      {
        id: 'fac-mal-clinic',
        name: 'Malumichampatti Rural Family Health Clinic & Dispensary',
        type: 'Clinic',
        category: 'Public',
        latitude: 10.915,
        longitude: 77.012,
        address: 'Pollachi Main Road, Malumichampatti, Coimbatore',
        district: 'Coimbatore',
        phone: '0422-2655120',
        emergencyCapability: false,
        totalBeds: 8,
        ...
        averageWaitTimeMin: 8,
        specialists: [
          { specialty: 'General Medicine', available: true, doctorName: 'Dr. Naveen Prasad' }
        ],
        services: ['Daily Outpatient Clinic', 'Geriatric Care & Chronic Drug Dispensing', 'Antenatal Checkup'],
        availableDiagnostics: ['Blood Sugar Test', 'ECG Basic', 'Pulse Oximetry', 'Urine Test'],
        medicineStockRatio: 0.90
      },
      {
        id: 'fac-sundar-clinic',
        name: 'Sundarapuram Urban Primary Health Clinic & Wellness Centre',
        type: 'Clinic',
        category: 'Associated',
        latitude: 10.952,
        longitude: 76.974,
        address: 'Madukkarai Market Road, Sundarapuram, Coimbatore',
        district: 'Coimbatore',
        phone: '0422-2672311',
        emergencyCapability: false,
        totalBeds: 12,
        ...
        specialists: [
          { specialty: 'General Medicine', available: true, doctorName: 'Dr. Mythili S.' }
        ],
        services: ['Urban Health OPD', 'Diabetes & Hypertension Clinic', 'Preventive Health Screening', 'Phlebotomy'],
        availableDiagnostics: ['Complete Blood Count (CBC)', 'Random Blood Sugar', 'Lipid Profile', 'ECG'],
        medicineStockRatio: 0.95
      },
      {
        id: 'fac-pollachi-clinic',
        name: 'Pollachi Sanjeevani Ayushman Clinic & Day Care',
        type: 'Clinic',
        category: 'Trust',
        latitude: 10.665,
        longitude: 77.008,
        address: 'Kottur Road, Pollachi, Coimbatore District',
        district: 'Coimbatore',
        phone: '04259-231155',
        emergencyCapability: false,
        totalBeds: 15,
        ...
        averageWaitTimeMin: 10,
        specialists: [
          { specialty: 'General Medicine', available: true, doctorName: 'Dr. G. Sivakumar' },
          { specialty: 'Pediatrics', available: true, doctorName: 'Dr. M. Soundarya' }
        ],
        services: ['Outpatient Family Medicine', 'Pediatric Clinic', 'Nebulization & First Aid', 'Physiotherapy'],
        availableDiagnostics: ['Point-of-Care Lab', 'ECG', 'Pulse Oximetry', 'Urine Chemistry'],
        medicineStockRatio: 0.93
      },
      {
        id: 'fac-psg-hosp',
        name: 'PSG Institute of Medical Sciences & Research (Apex Tertiary Hospital)',
        ...
        averageWaitTimeMin: 12,
        specialists: [
          { specialty: 'Cardiology', available: true, doctorName: 'Dr. J. Balachandar' },
          { specialty: 'Cardiac Surgery', available: true, doctorName: 'Dr. P. R. Murugesan' },
          { specialty: 'Neurology', available: true, doctorName: 'Dr. S. V. Balasubramanian' },
          { specialty: 'Nephrology', available: true, doctorName: 'Dr. G. Senthil Kumar' }
        ],
        services: [
          '24x7 Level-1 Trauma Care',
          'Coronary Care Unit & Emergency Primary PCI Angioplasty',
          'Comprehensive Stroke Interventions',
          'Surgical ICU',
          'Dialysis Hub'
        ],
        availableDiagnostics: [
      ...
      {
        id: 'fac-ganga-hosp',
        name: 'Ganga Medical Centre & Emergency Trauma Super Specialty Hospital',
        type: 'Specialist Medical College',
        category: 'Associated',
        latitude: 11.018,
        longitude: 76.953,
        ...
        averageWaitTimeMin: 15,
        specialists: [
          { specialty: 'Orthopedics', available: true, doctorName: 'Dr. S. Rajasekaran' },
          { specialty: 'General Surgery', available: true, doctorName: 'Dr. Raja Shanmuga Krishnan' },
          { specialty: 'Cardiology', available: true, doctorName: 'Dr. K. Jayashree' }
        ],
        services: [
          'Advanced Polytrauma & Resuscitation Center',
          'Emergency ICU',
        ...
        medicineStockRatio: 0.97
      },
      {
        id: 'fac-kmch-hosp',
        name: 'Kovai Medical Center and Hospital (KMCH Super Specialty)',
        type: 'Specialist Medical College',
        category: 'Associated',
        latitude: 11.054,
        longitude: 77.051,
        address: '99, Avinashi Road, Civil Aerodrome Post, Coimbatore',
        district: 'Coimbatore',
        phone: '0422-4323800',
        emergencyCapability: true,
        totalBeds: 1000,
        ...
        occupiedIcuBeds: 76,
        currentQueueLength: 6,
        averageWaitTimeMin: 14,
        specialists: [
          { specialty: 'Cardiology', available: true, doctorName: 'Dr. Thomas Alexander' },
          { specialty: 'Pulmonology', available: true, doctorName: 'Dr. V. Arulselvan' },
          { specialty: 'Neurology', available: true, doctorName: 'Dr. S. Murali' }
        ],
        services: [
        ...
        medicineStockRatio: 0.99
      },
      {
        id: 'fac-tpr-gh',
        name: 'Tirupur District Headquarters Government Hospital',
        type: 'District Hospital',
        category: 'Public',
        latitude: 11.108,
        longitude: 77.341,
        address: 'Kumaran Road, Tirupur',
        district: 'Tirupur',
        phone: '0421-2242100',
        emergencyCapability: true,
        totalBeds: 600,
        ...
        specialists: [
          { specialty: 'General Medicine', available: true, doctorName: 'Dr. N. Murugesan' },
          { specialty: 'Cardiology', available: true, doctorName: 'Dr. P. Selvaraj' },
          { specialty: 'Obstetrics/Gynecology', available: true, doctorName: 'Dr. R. Gomathi' }
        ],
        services: [
    ...
    for (const fac of additionalFacilities) {
      const idx = this.data.facilities.findIndex(f => f.id === fac.id);
      if (idx >= 0) {
        this.data.facilities[idx] = fac;
      } else {
        this.data.facilities.push(fac);
      }
    }

    // Synchronize community village patients
    const additionalPatients: Patient[] = [
      {
        id: 'pat-4',
        userId: 'usr-pat-4',
        abhaId: '91-3310-7744-1188',
        name: 'Kavitha Selvam',
        ...
        emergencyContactName: 'Selvam (Spouse)',
        emergencyContactPhone: '+91 94430 33112',
        conditions: ['Bronchial Asthma', 'Seasonal Dust Allergy'],
        allergies: ['Dust mites', 'Aspirin'],
        medications: ['Salbutamol Inhaler 100mcg SOS', 'Budesonide 200mcg BD']
      },
      {
        id: 'pat-5',
        userId: 'usr-pat-5',
        abhaId: '91-8822-4411-9955',
        name: 'Ananya Murugan',
        ...
        longitude: 77.021,
        assignedWorkerId: 'hw-1',
        emergencyContactName: 'Murugan Shanmugam (Father)',
        emergencyContactPhone: '+91 94430 11234',
        conditions: ['Routine Pediatric Viral Pyrexia', 'Mild Upper Respiratory Infection'],
        allergies: [],
        medications: ['Paracetamol syrup 250mg SOS']
      },
      {
        id: 'pat-6',
        userId: 'usr-pat-6',
        abhaId: '91-6655-2233-4411',
        name: 'Rajesh Kannan',
        ...
        longitude: 77.019,
        assignedWorkerId: 'hw-1',
        emergencyContactName: 'Geetha Kannan (Spouse)',
        emergencyContactPhone: '+91 94430 88221',
        conditions: ['Chronic Stable Angina', 'Ischemic Heart Disease', 'Heavy Smoker (History)'],
        allergies: ['Contrast Dye'],
        medications: ['Isosorbide Mononitrate 20mg BD', 'Aspirin 75mg OD', 'Atorvastatin 40mg HS']
      }
    ];

    if (!this.data.patients) this.data.patients = [];
    for (const pat of additionalPatients) {
      const idx = this.data.patients.findIndex(p => p.id === pat.id);
      if (idx >= 0) {
        this.data.patients[idx] = pat;
      } else {
        this.data.patients.push(pat);
      }
    }

    // Save updated synchronization back
    this.save();
  }
