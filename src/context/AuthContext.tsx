...
import { Language, translations, translateText } from '../i18n/translations';
...
interface AuthContextType {
  ...
  translate: (text: string | undefined | null) => string;
  isOffline: boolean;
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const translate = (text: string | undefined | null) => translateText(text, language);
